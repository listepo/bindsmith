...
@interface _en4lbl_BlockArgs_xtuoz7 : NSObject
@property (copy) id block;
@property (strong) id arg0;
@end
@implementation _en4lbl_BlockArgs_xtuoz7
@end

typedef void  (^_ListenerTrampoline)(id arg0);
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _en4lbl_wrapListenerBlock_xtuoz7(
  ...
  _ListenerTrampoline strongSelfBlock = [^void(id arg0) {
    @autoreleasepool {
      _en4lbl_BlockArgs_xtuoz7* args = [[_en4lbl_BlockArgs_xtuoz7 alloc] init];
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _en4lbl_wrapBlockingBlock_xtuoz7(int64_t port, DOBJC_Context* ctx,
